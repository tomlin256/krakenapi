...
Triggers Triggers::from_json(const json& j) {
    Triggers t;
...
json Conditional::to_json() const {
    json j;
...
Conditional Conditional::from_json(const json& j) {
    Conditional c;
...
json OrderParams::to_json() const {
    json j;
...
OrderParams OrderParams::from_json(const json& j) {
    OrderParams p;
...
OrderDescription OrderDescription::from_json(const json& j) {
    OrderDescription d;
    d.pair     = j.value("pair", "");
...
OrderInfo OrderInfo::from_json(const json& j, const std::string& id) {
    OrderInfo o;
    o.txid      = id;
...
TradeInfo TradeInfo::from_json(const json& j, const std::string& id) {
    TradeInfo t;
    t.txid      = id;
...
LedgerEntry LedgerEntry::from_json(const json& j, const std::string& id) {
    LedgerEntry e;
    e.txid    = id;
