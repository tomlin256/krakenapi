...
#  pragma message("kraken_ws_client.hpp is deprecated; include exchange/kraken/ws_client.hpp. See docs/plans/001-appendix-migration-guide.md (removed in vNEXT_MAJOR).")
#endif
