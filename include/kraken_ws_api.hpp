...
#  pragma message("kraken_ws_api.hpp is deprecated; include exchange/kraken/ws_api.hpp. See docs/plans/001-appendix-migration-guide.md (removed in vNEXT_MAJOR).")
#endif
